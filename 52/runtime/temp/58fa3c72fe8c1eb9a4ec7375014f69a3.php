<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"F:\wamp\www\tp\52/application/admin\view\ajaxsubmit\index.html";i:1481080251;}*/ ?>
<div class="l-segment l-border-0 example-layout pageLayout">
    ...
    <form action="./ajaxsubmit/saveError.html" class="m-ajaxSubmit" callback='afterBack:afterBackTest'>
        <div class="l-row-padding">
            <div class="l-col-2 m-input">
                <label for="">输入项1</label>
                <input name='name1' type="text">
