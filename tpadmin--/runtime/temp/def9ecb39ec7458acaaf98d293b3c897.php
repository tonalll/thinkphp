<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"F:\wamp\www\tp\tpadmin\public/../application/admin\view\admin_node\index.html";i:1482306707;s:74:"F:\wamp\www\tp\tpadmin\public/../application/admin\view\template\base.html";i:1482306707;s:85:"F:\wamp\www\tp\tpadmin\public/../application/admin\view\template\javascript_vars.html";i:1482306707;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="pos-f tp-page-aside">
    <div class="panel panel-primary tp-panel tp-panel-module">
        ...
        <div class="panel-body tp-box-list">
            <ul id="module-list">
                <?php if(is_array($modules) || $modules instanceof \think\Collection): if( count($modules)==0 ) : echo "" ;else: foreach($modules as $key=>$module): ?>
